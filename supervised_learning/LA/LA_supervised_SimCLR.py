...
def run_supervised_SimCLR(requires_meteo=False, train_stations=-1, lr=5e-7):
    ...
    # ssl_path = '../../model_checkpoint/encoder_params_resnet18_spatiotemporal_LA_SimCLR.pkl'
    ssl_path = '../../model_checkpoint/encoder_params_resnet50_spatiotemporal_LA_SimCLR.pkl'
...
def cli_main():
    ...
    lrs_no_meteo = [8e-6, 4e-6, 2e-6, 1e-6, 5e-7]   # ResNet50
    lrs_meteo = []   # ResNet50
