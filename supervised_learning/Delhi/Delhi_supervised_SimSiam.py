...
def cli_main():
    ...
    lrs_no_meteo = [7e-4, 2e-4, 8e-5, 5e-5, 5e-5, 4e-5]   # ResNet18
    lrs_meteo = [3e-6, 2.5e-6, 2e-6, 1.5e-6, 1e-6, 1e-6]   # ResNet18
#     lrs_no_meteo = [1e-5, 5e-6, 2e-6, 1e-6, 5e-7, 3e-7]   # ResNet50
#     lrs_meteo = [2e-6, 3e-7, 2e-7, 2e-7, 2e-7, 2e-7]   # ResNet50
