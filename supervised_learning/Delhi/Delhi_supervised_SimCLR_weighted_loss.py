...
def run_supervised_SimCLR(requires_meteo=False, train_stations=-1, lr=5e-7):
    ...
    result_path = './model_results/results_SimCLR_weighted_loss.pkl'
...
def cli_main():
    ...
    lrs_no_meteo = [8e-6, 2e-6, 2e-6, 1.5e-6, 1.5e-6, 1.5e-6]   # ResNet18
    lrs_meteo = [8e-7, 1e-7, 1e-7, 3e-7, 3e-7, 3e-7]   # ResNet18
#     lrs_no_meteo = [5e-6, 2e-6, 1.5e-6, 1.5e-6, 1e-6, 1e-6]   # ResNet50
#     lrs_meteo = [5e-7, 6e-8, 2e-7, 2e-7, 2.5e-7, 3e-7]   # ResNet50
