...
def cli_main():
    ...
    lrs_no_meteo = [5e-5, 1e-5, 9e-6, 7e-6, 5e-6, 4e-6]  # ResNet18
    lrs_meteo = [3e-6, 2.5e-6, 2e-6, 1.5e-6, 1e-6, 1e-6]  # ResNet18
#     lrs_no_meteo = [2e-5, 7e-6, 3e-6, 2e-6, 1e-6, 8e-7]   # ResNet50
#     lrs_meteo = [2.5e-6, 2.5e-7, 2.5e-7, 2e-7, 2e-7, 2e-7]   # ResNet50
