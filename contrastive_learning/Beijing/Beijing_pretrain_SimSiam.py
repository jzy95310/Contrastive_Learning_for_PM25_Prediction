...
def cli_main():
    input_height = 100
    train_dataset_SSL = MySSLImageDataset(root_dir='../../data/Beijing_labeled_grouped_by_date_SimCLR_SimSiam.pkl', mode='train',
                                      transform=SpatiotemporalTransform(input_height=input_height), batch_size=256)
    val_dataset_SSL = MySSLImageDataset(root_dir='../../data/Beijing_labeled_grouped_by_date_SimCLR_SimSiam.pkl', mode='val', 
...
#     )
    ...
    torch.save(simsiam_encoder.state_dict(), '../../model_checkpoint/encoder_params_resnet50_spatiotemporal_Beijing_SimSiam.pkl')
